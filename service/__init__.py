...
def initRoute(app):
    ...
    # ----------
        if request.method == 'GET':
            ...
            myans, myarr = dl_folder()
            print("myarr")
            print(myarr)

            #######################################################3
            return render_template('index.html',myans = myans[0],myans2 = myans[1],myans3 = myans[2],myans4 = myans[3], myans5= myans[4][0], myans6= myans[4][1], myans7= myans[4][2], myans8=myans[4] , myarr = myarr )
